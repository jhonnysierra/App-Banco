...
public class Utilidades {
    ...
    /**
     * Metodo que permite calcular la diferencia en dias entre dos fechas
     * @param fechaIncial fecha inicial
    ...
    /**
     * Metodo que permite calcular una fecha final dada una fecha inicial y una cantidad de dias habiles a calcular
     * @param fechaInicial Fecha inicial
     * @param diasHabiles Dias habiles a sumar
     * @return Fecha final resultado de la suma de los dias habiles a la fecha inicial
     */
